...
and ambient capability stack have been removed; runtime regressions exercise real worker paths. `tool.rs`, `supervisor.rs`, `pipe.rs`, `broker.rs`, and `audit.rs` remain in the
