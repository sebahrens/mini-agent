class Zerostack < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.7.0/mini-agent-x86_64-apple-darwin.tar.gz"
      sha256 "20073c9b95629d8ca07716def668c7d8f52616571bbc435bb7a9c4db99719bfb"
    else
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.7.0/mini-agent-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.7.0/mini-agent-x86_64-unknown-linux-musl.tar.gz"
      sha256 "bee067458568c2b021dced37d91377301ee356d792b855c119f48f03cd698364"
    else
      url "https://github.com/gi-dellav/zerostack/releases/download/v1.7.0/mini-agent-aarch64-unknown-linux-musl.tar.gz"
