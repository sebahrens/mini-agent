...
fn windows_worker_runtime_probe_source_covers_the_required_security_matrix() {
    ...
    for required in [
        ...
        "TerminateJobObject(helper.job.raw(), 1)",
        "preflight_job_active_processes",
        "restore_executable_dacl",
        "AclMutationGuard::acquire_until(run_deadline)",
        ...
        "containment_check(0x2001",
        "containment_check(0x2002",
        "containment_check(0x2003",
        "containment_check(0x2004",
        "containment_check(0x2005",
        "containment_check(0x2006",
        "containment_check(0x2007",
        "containment_check(0x2008",
        "containment_check(0x2009",
        "containment_check(0x200A",
        "containment_check(0x200B",
        "child_token_is_zero_capability_lpac()",
        "lpac_all_packages_access_matches",
        "S-1-15-2-2",
        "AccessCheck(",
        "expected LPAC restricted-packages access",
        "TOKEN_DUPLICATE",
        "SecurityImpersonation",
        "map_err(|_| 0x2102u16)",
        "Err(0x2106)",
        "containment_check(0x200C",
        "containment_check(0x200D",
